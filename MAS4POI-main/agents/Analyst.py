...
class Analyst:
    ...
    def generate_recommendation(
        ...
        try:
            ...
            print("candidates/poi_id:",candidates[0][0])
            print("true:",groundTruth[0])
            ...
            if self.prompt_id == 'a':
                ...
                prompt = self.create_prompt_c(candidates,user_id, trajectory, poi_id, id_range, time, recent, longterm)
            ...
            print(groundTruth[0])
            return prediction, longterm, recent, candidates
        except Exception as e:
